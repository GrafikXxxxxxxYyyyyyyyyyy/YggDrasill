...
def test_sd15_img2img_objective_uses_init_image(tmp_path) -> None:
    import torch
    ...
    objective = SD15Img2ImgLoRAObjective(
    ...
    objective.compute_loss({"caption": ["castle"], "init_pixel_values": torch.randn(1, 3, 16, 16)})
