"""Single-step SDXL text2img LoRA training objective."""
...
class SDXLText2ImgLoRAObjective:
    """SDXL base text2img objective with dual encoders and added conditioning."""
    ...
    def compute_loss(self, batch: Dict[str, Any]) -> Any:
        ...
        prompt_embeds, pooled_embeds = self._encode_prompt_conditioning(batch)
