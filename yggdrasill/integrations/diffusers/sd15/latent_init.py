...
class SD15LatentInitNode(AbstractOuterModule):
    ...
    def _forward_from_encoded_latents(
        ...
        # AnimateDiff img2video: (B, C, F, H, W) — add_noise on (B*F, C, H, W) then reshape back.
    ...
    def _forward_from_encoded_latents_5d(
        ...
        """Img2video / video2video: encoded latents (B,C,F,H,W), same timestep schedule as 4D path."""
        import torch
